(function() {
  ...
  const staticAssets = [
    'https://uwcblogs.com/assets/css/styles.css',
    'https://uwcblogs.com/assets/css/choices.css',

    'https://use.typekit.net/mba1aft.js',
    'https://uwcblogs.com/assets/js/lazysizes.min.js',
    'https://unpkg.com/headroom.js',
    'https://uwcblogs.com/assets/js/choices.min.js',
    'https://uwcblogs.com/assets/js/smooth-scroll.min.js',
  ];
